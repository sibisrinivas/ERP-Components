<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="view_trainning.aspx.cs" Inherits="Dead_Stocks" %>
...
<br />
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
          CellPadding="4" DataKeyNames="event_name" DataSourceID="SqlDataSource1" 
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="SELECT * FROM [new_event]"></asp:SqlDataSource>
<br />
<br />
<br />
<br />
