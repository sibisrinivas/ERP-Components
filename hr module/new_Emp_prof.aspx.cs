...
public partial class Payment : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("insert into pemp (emp_name, emp_id, designation, department_name, exp, salary) values('" + TextBox1.Text + "'," + TextBox2.Text + ",'" + TextBox4.Text + "','" + DropDownList1.SelectedItem.Value + "'," + TextBox3.Text + ", " + TextBox6.Text + ")", con);
