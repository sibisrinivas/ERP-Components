<%@ Page Language="C#" MasterPageFile="~/Employee/EmpMasterPage.master" AutoEventWireup="true"
    CodeFile="ChangePassword.aspx.cs" Inherits="Admin_ChangePassword" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel1" runat="server" Height="173px" Style="z-index: 100; left: 195px;
        position: absolute; top: 102px" Width="299px">
        &nbsp;
        <table style="z-index: 100; left: 10px; position: absolute; top: 11px; width: 282px;"
            class="MainTable">
            <tr>
    ...
    <asp:Label ID="Label1" runat="server" CssClass="HLabel" Style="z-index: 102; left: 235px;
        position: absolute; top: 48px" Text="CHANGE YOUR PASSWORD" Width="212px"></asp:Label>
</asp:Content>
